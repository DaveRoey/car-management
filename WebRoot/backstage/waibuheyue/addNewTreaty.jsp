    ...
    <div class="tpl-block">
        ...
        <div class="am-g">
            <div class="tpl-form-body tpl-form-line">
                <form id="uploadForm" method="post" class="am-form tpl-form-line-form">

                    <div class="am-form-group">
                        <label for="treaty-old" class="am-u-sm-3 am-form-label">原合同号 </label>
                        <div class="am-u-sm-9">
                            <input type="text" disabled value="${treaty.treatyNumber}" class="tpl-form-input"
                                   id="treaty-old" placeholder="请输入合同号">
                        </div>
                        <input type="hidden" name="treaty.treatyId" value="${treaty.treatyId}">
                    </div>

                    <div class="am-form-group">
                        <label for="treaty-number" class="am-u-sm-3 am-form-label">新合同号 </label>
                        <div class="am-u-sm-9">
                            <input type="text" name="newNumber" class="tpl-form-input" id="treaty-number"
                                   placeholder="请输入合同号">
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <input type="text" name="startDate" id="start-time" value="${treaty.startDate}"
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <input type="text" name="endDate" id="end-time" value="${treaty.endDate}"
                                   class="am-form-field tpl-form-no-bg"
                                   placeholder="合同到期时间"
                                   data-am-datepicker="" readonly/>
                            <small>到期时间为必填</small>
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <input type="text" disabled value="蜗牛创想有限公司" id="treaty-com" placeholder="合同单位">
                            <input type="hidden" value="${treaty.company}" name="company">
                            <small></small>
                        </div>
                    </div>
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <input type="text" name="contact" value="${treaty.contact}" id="contact" placeholder="联系人">
                            <small></small>
                        </div>
                    </div>
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <input type="tel" name="phone" value="${treaty.phone}" id="phone" placeholder="联系电话">
                            <small></small>
                        </div>
                    </div>
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <input type="number" name="count" value="${treaty.count}" id="port-number"
                                   placeholder="车位数量">
                            <small></small>
                        </div>
                    </div>
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <div class="am-form-group am-form-file">
                                ...
                                <input type="hidden" name="treatyImg" id="imgSize1">
                            </div>
                        </div>
                    </div>
                    <div class="am-form-group">
                        <div class="am-u-sm-9 am-u-sm-push-3">
                            <button type="button" id="addNewTreaty"
...
<script type="text/javascript">
    $(function () {
        ...
        /*添加合同*/
        $("#addNewTreaty").on("click", function () {
            if (checkTtreatyId() && checkComName() && checkContract() && checkPhone() && checkNumber() && checkDate()&&checkImg()) {
                getPageByUrl("${pageContext.request.contextPath}/waibuheyue/addNew.do", $("#uploadForm").serializeArray());
