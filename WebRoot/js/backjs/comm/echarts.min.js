!function (t, e) {
    ...
    return function (t) {
        ...
        function f(t, e, i) {
            if (t && e)if (t.forEach && t.forEach === z) t.forEach(e, i); else if (t.length === +t.length)for (var n = 0,
                                                                                                                   r = t.length; r > n; n++)e.call(i, t[n], n, t); else for (var o in t)t.hasOwnProperty(o) && e.call(i, t[o], o, t)
        }
        ...
        function l(t, e) {
            for (var i = "component" === t, n = i ? this._componentsViews : this._chartsViews,
                     r = i ? this._componentsMap : this._chartsMap, o = this._zr,
                     a = 0; a < n.length; a++)n[a].__alive = !1;
        ...
        n.prototype = {
            constructor: n, init: null, mergeOption: function (t) {
                ...
                for (var i = this.option, n = this.parentModel,
        ...
        s.normalizeToArray = function (t) {
            ...
            function i(t, e, i) {
                for (var n = 0, r = t.length; r > n; n++)for (var o = t[n].seriesId,
                                                                  a = s.normalizeToArray(t[n].dataIndex), l = i && i[o],
                                                                  u = 0, h = a.length; h > u; u++) {
                    var c = a[u];
        ...
        (function (e) {
            ...
            y.type = "list", y.hasItemOption = !0, y.getDimension = function (t) {
                ...
                for (var e = this.dimensions, i = this._dimensionInfos, n = 0,
                ...
                if (o)return o;
                if (i) {
                    for (var a = 1 / 0, s = -(1 / 0), l = 0,
                             u = this.count(); u > l; l++)r = this.get(t, l, e), a > r && (a = r), r > s && (s = r);
                ...
                for (var o = r(this, [t]), a = this._storage, s = o._storage, l = this.indices, u = o.indices = [],
        ...
        function n(t, e) {
            ...
            if (l[i])return l[i];
            for (var n = (t + "").split("\n"), r = 0, o = 0,
                     a = n.length; a > o; o++)r = Math.max(p.measureText(n[o], e).width, r);
        ...
        function a(t, e, i, r, o) {
            if (!e)return "";
            o = o || {}, r = f(r, "...");
            for (var a = f(o.maxIterations, 2), l = f(o.minChar, 0), u = n("国", i), h = n("a", i),
                     c = f(o.placeholder, ""), d = e = Math.max(0, e - 1), p = 0; l > p && d >= h; p++)d -= h;
            var g = n(r);
            g > d && (r = "", g = 0), d = e - g;
        ...
        function o(t, e, i) {
            ...
            if (null != n)for (var a = n instanceof Array ? n : [n], s = 0,
                                   l = a.length; l > s; s++)r(t.getItemGraphicEl(a[s]), i); else if (o)for (var u = o instanceof Array ? o : [o],
                                                                                                                s = 0,
                                                                                                                l = u.length; l > s; s++) {
        ...
        l.prototype = {
            constructor: l, contain: function (t) {
                ...
                for (var t = this.getExtent(), e = [], i = this.scale.count(), n = t[0], r = t[1], o = r - n,
                         a = 0; i > a; a++)e.push([o * a / i + n, o * (a + 1) / i + n]);
                return e
            ...
            constructor: n, add: function (t) {
                ...
                for (var t = 0; t < u.length; t++) {
                    ...
                    if (s.hasOwnProperty(h)) {
                        var c = s[h];
                        if (null == c)continue;
                        if (c.length)for (var f = 0,
                                              d = c.length; d > f; f++)this._add && this._add(c[f]); else this._add && this._add(c)
                    }
                }
            }
        }, t.exports = n
        ...
        h._updateCommon = function (t, e, i, r) {
            ...
            null != M && (S.opacity = M);
            for (var T, A,
                     I = t.dimensions.slice(); I.length && (T = I.pop(), A = t.getDimensionInfo(T).type, "ordinal" === A || "time" === A););
        ...
        var x = {
            axisLine: function () {
                ...
                if (t.get("axisTick.show"))for (var e = t.axis, i = t.getModel("axisTick"), n = this.opt,
                                                    r = i.getModel("lineStyle"), o = i.get("length"),
                                                    a = b(i, n.labelInterval),
                                                    l = e.getTicksCoords(i.get("alignWithLabel")),
                                                    h = e.scale.getTicks(), c = [], d = [], f = this._transform,
                                                    p = 0; p < l.length; p++)if (!_(e, p, a)) {
                    var v = l[p];
                ...
                if (o) {
                    ...
                    g = g * m / 180;
                    for (var y = r(e, g, e.labelDirection), x = i.get("data"), b = [], w = a(i),
                             S = i.get("triggerEvent"), M = 0; M < f.length; M++)if (!_(s, M, e.labelInterval)) {
                        var T = c;
        ...
        m.type = "grid", m.getRect = function () {
            ...
            for (var n = 0,
                     r = this._coordsList; n < r.length; n++)if (r[n].getAxis("x").index === t || r[n].getAxis("y").index === e)return r[n]
        ...
        function s(t, e, i, n, r) {
            var a = t.length;
            if (1 == r)for (var s = 0; a > s; s++)n[s] = o(t[s], e[s], i); else for (var l = t[0].length,
                                                                                         s = 0; a > s; s++)for (var u = 0; l > u; u++)n[s][u] = o(t[s][u], e[s][u], i)
        }
        ...
        function l(t, e, i) {
            ...
            for (var s = t[0] && t[0].length,
                     a = 0; a < t.length; a++)if (1 === i) isNaN(t[a]) && (t[a] = e[a]); else for (var l = 0; s > l; l++)isNaN(t[a][l]) && (t[a][l] = e[a][l])
        }
        ...
        function u(t, e, i) {
            ...
            if (1 === i) {
                for (var r = 0; n > r; r++)if (t[r] !== e[r])return !1
                            ...
                            r = 0; n > r; r++)for (var a = 0; o > a; a++)if (t[r][a] !== e[r][a])return !1;
            return !0
        }

        function h(t, e, i, n, r, o, a, s, l) {
            var u = t.length;
            if (1 == l)for (var h = 0; u > h; h++)s[h] = c(t[h], e[h], i[h], n[h], r, o, a); else for (var d = t[0].length,
                                                                                                           h = 0; u > h; h++)for (var f = 0; d > f; f++)s[h][f] = c(t[h][f], e[h][f], i[h][f], n[h][f], r, o, a)
        }
        ...
        function p(t, e, i, n, r) {
            ...
            if (x) {
                ...
                if (!C) {
                    for (var z = I[x - 1],
                             D = 0; x - 1 > D; D++)w ? l(I[D], z, T) : !isNaN(I[D]) || isNaN(z) || M || S || (I[D] = z);
        ...
        o.prototype = {
            ...
            getGradient: function (t, e, r) {
                for (var o = "radial" === e.type ? n : i, a = o(t, e, r), s = e.colorStops,
        ...
        function d(t, e, i) {
            for (var n = e.getBaseAxis(), r = "x" === n.dim || "radius" === n.dim ? 0 : 1, o = [],
                     a = 0; a < t.length - 1; a++) {
                var s = t[a + 1], l = t[a];
                o.push(l);
                var u = [];
        ...
        t.exports = function (t, e, i, o, a, s) {
            for (var l = r(t, e), u = [], h = [], c = [], d = [], f = [], p = [], g = [], v = s.dimensions,
                     m = 0; m < l.length; m++) {
                var y = l[m], x = !0;
                switch (y.cmd) {
                    case"=":
        ...
        function n(t, e, i, n, r, o, a) {
            ...
            function u(t, e, i, n, r, o) {
                for (var a = o > 0 ? e ? Number.MAX_VALUE : 0 : e ? Number.MAX_VALUE : 0, s = 0,
                         l = t.length; l > s; s++)if ("center" !== t[s].position) {
            ...
            for (var h, c = 0, d = t.length, f = [], p = [],
                     g = 0; d > g; g++)h = t[g].y - c, 0 > h && s(g, d, -h, r), c = t[g].y + t[g].height;
            0 > a - c && l(d - 1, c - a);
            ...
            c = i(2).extendComponentView({
                type: "axis", render: function (t, e) {
                    ...
                    var n = t.axis, a = t.getModel("splitLine"), u = a.getModel("lineStyle"), h = u.get("color"),
                        c = l(a, i);
                    h = r.isArray(h) ? h : [h];
                    for (var d = e.coordinateSystem.getRect(), f = n.isHorizontal(), p = 0, g = n.getTicksCoords(),
                             v = n.scale.getTicks(), m = [], y = [], x = u.getLineStyle(),
                             _ = 0; _ < g.length; _++)if (!s(n, _, c)) {
        ...
        function P(t, e) {
            ...
            if (t._brushType) {
                for (var o, a = t._panels, s = t._covers,
                         l = 0; l < s.length; l++)if (nt[s[l].__brushOption.brushType].contain(s[l], i, n)) {
                    o = !0;
                    break
                }
                o || (a ? W(a, function (t) {
            ...
            x = c.isObject, _ = i(10), b = i(124), w = "\x00_ec_inner", S = f.extend({
                constructor: S, init: function (t, e, i, n) {
                    ...
                    return p(t, function (e, i) {
                        if (_.hasClass(i)) {
                            for (var e = d.normalizeToArray(e),
                                     n = e.length - 1; n >= 0; n--)d.isIdInner(e[n]) && e.splice(n, 1);
                            t[i] = e
                        }
                    }), delete t[w], t
                }, getTheme: function () {
        ...
        h.prototype = {
            constructor: h, mousemove: function (t) {
                ...
                for (var r = "on" + e, o = n(e, t, i),
                         a = t; a && (a[r] && (o.cancelBubble = a[r].call(a, o)), a.trigger(e, o), a = a.parent, !o.cancelBubble););
                ...
                for (var n = this.storage.getDisplayList(),
                         r = n.length - 1; r >= 0; r--)if (!n[r].silent && n[r] !== i && !n[r].ignore && o(n[r], t, e))return n[r]
            }
        ...
        b.prototype = {
            constructor: b, isSingleCanvas: function () {
                ...
                for (var n, r, o, a, s, l, u = 0, h = this._width, c = this._height, p = this._progress, g = 0,
                         v = t.length; v > g; g++) {
        ...
        l.prototype = {
            constructor: l, traverse: function (t, e) {
                ...
                for (var e = this._roots, i = this._displayList, r = 0,
                         a = e.length; a > r; r++)this._updateAndAddDisplayable(e[r], null, t);
        ...
        t.exports = n.extend({
            type: "compound", shape: {paths: null}, _updatePathDirty: function () {
                ...
                for (var t = this.shape.paths || [], e = this.getGlobalScale(),
                         i = 0; i < t.length; i++)t[i].path.setScale(e[0], e[1])
            }, buildPath: function (t, e) {
        ...
        for (var l = ["getLayer", "insertLayer", "eachLayer", "eachBuildinLayer", "eachOtherLayer", "getLayers", "modLayer", "delLayer", "clearLayer", "toDataURL", "pathToImage"],
                 u = 0; u < l.length; u++) {
            var h = l[u];
            r.prototype[h] = o(h)
        }
        ...
        var n = i(13), r = {
            getItemAlign: function (t, e, i) {
                ...
                for (var a = {width: e.getWidth(), height: e.getHeight()}, s = "horizontal" === r.orient ? 1 : 0,
                         l = [["left", "right", "width"], ["top", "bottom", "height"]], u = l[s], h = [0, null, 10],
                         c = {}, d = 0; 3 > d; d++)c[l[1 - s][d]] = h[d], c[u[d]] = 2 === d ? i[0] : r[u[d]];
        ...
        n.prototype = {
            constructor: n, getBoundingRect: function () {
                var t = this._rect;
                if (t)return t;
                for (var e = Number.MAX_VALUE, i = [e, e], n = [-e, -e], r = [], l = [], u = this.contours,
                         h = 0; h < u.length; h++)a.fromPoints(u[h], r, l), s.min(i, i, r), s.max(n, n, l);
                return 0 === h && (i[0] = i[1] = n[0] = n[1] = 0), this._rect = new o(i[0], i[1], n[0] - i[0], n[1] - i[1])
            }, contain: function (t) {
                var e = this.getBoundingRect(), i = this.contours;
                if (e.contain(t[0], t[1]))for (var n = 0,
                                                   o = i.length; o > n; n++)if (r.contain(i[n], t[0], t[1]))return !0;
                return !1
            }, transformTo: function (t, e, i, n) {
                var r = this.getBoundingRect(), a = r.width / r.height;
                i ? n || (n = i / a) : i = a * n;
                for (var l = new o(t, e, i, n), u = r.calculateTransform(l), h = this.contours,
                         c = 0; c < h.length; c++)for (var d = 0; d < h[c].length; d++)s.applyTransform(h[c][d], h[c][d], u);
        ...
        var o = i(263), a = i(3), s = i(4), l = s.parsePercent, u = 2 * Math.PI, h = i(27).extend({
            type: "gauge", render: function (t, e, i) {
                ...
                for (var o = this.group, s = t.getModel("axisLine"), l = s.getModel("lineStyle"),
                         h = t.get("clockwise"), c = -t.get("startAngle") / 180 * Math.PI,
                         d = -t.get("endAngle") / 180 * Math.PI, f = (d - c) % u, p = c, g = l.get("width"),
                         v = 0; v < n.length; v++) {
                ...
                for (var d = this.group, f = o.cx, p = o.cy, g = o.r, v = t.get("min"), m = t.get("max"),
                         y = t.getModel("splitLine"), x = t.getModel("axisTick"), _ = t.getModel("axisLabel"),
                         b = t.get("splitNumber"), w = x.get("splitNumber"), S = l(y.get("length"), g),
                         M = l(x.get("length"), g), T = u, A = (h - u) / b, I = A / w,
                         L = y.getModel("lineStyle").getLineStyle(), C = x.getModel("lineStyle").getLineStyle(),
                         D = _.getModel("textStyle"), P = 0; b >= P; P++) {
        ...
        t.exports = function (t, e, i) {
            for (var o = i.rect, a = o.width, s = o.height, l = [o.x + a / 2, o.y + s / 2],
                     u = null == i.gravity ? .1 : i.gravity, h = 0; h < t.length; h++) {
                var c = t[h];
        ...
        t.exports = function (t) {
            t.eachSeriesByType("graph", function (t) {
                ...
                if (!e || "view" === e.type)if ("force" === t.get("layout")) {
                    ...
                    b.step = function (t) {
                        for (var e = 0,
                                 n = y.length; n > e; e++)y[e].fixed && s.copy(y[e].p, u.getNodeByIndex(e).getLayout());
                        w(function (e, n, r) {
                            for (var o = 0,
                                     a = e.length; a > o; o++)e[o].fixed || u.getNodeByIndex(o).setLayout(e[o].p), i[h.getId(o)] = e[o].p;
        ...
        n.prototype = {
            update: function (t, e, i, n, o, a) {
                ...
                for (var _ = d.getImageData(0, 0, c.width, c.height), b = _.data, w = 0, S = b.length,
                         M = this.minOpacity, T = this.maxOpacity, A = T - M; S > w;) {
                ...
                for (var n = this._gradientPixels, r = n[i] || (n[i] = new Uint8ClampedArray(1024)), o = [], a = 0,
                         s = 0; 256 > s; s++)e[i](s / 255, !0, o), r[a++] = o[0], r[a++] = o[1], r[a++] = o[2], r[a++] = o[3];
                return r
            }
        }, t.exports = n
    }, function (t, e, i) {
        ...
        f.stopEffectAnimation = function () {
            ...
            for (var e = this._effectCfg, i = this.childAt(1), n = ["symbolType", "period", "rippleScale"],
                     o = 0; n > o; o++) {
                var a = n[o];
        ...
        var r = i(3), o = i(83), a = i(82), s = r.extendShape({
            shape: {polyline: !1, segs: []}, buildPath: function (t, e) {
                ...
                for (var i = this.shape, n = i.segs, r = i.polyline, s = Math.max(this.style.lineWidth, 1),
                         l = 0; l < n.length; l++) {
                    var u = n[l];
                    if (r) {
        ...
        var n = i(14), r = i(15), o = i(1), a = i(30), s = i(8), l = s.encodeHTML, u = s.addCommas, h = i(66),
            c = i(171), d = r.extend({
                ...
                formatTooltip: function (t) {
                    for (var e = this.getData(), i = u(this.getRawValue(t)), n = e.getName(t), r = this.seriesGroup, o = [],
                             a = 0; a < r.length; a++) {
        ...
        function n(t, e) {
            ...
            return t[0].map(n, function (n, r) {
                for (var o = t[0].getName(r), a = 0, s = 1 / 0, l = -(1 / 0), u = i[o].length,
                         h = 0; u > h; h++)s = Math.min(s, i[o][h]), l = Math.max(l, i[o][h]), a += i[o][h];
                var c;
        ...
        n.prototype = {
            constructor: n, render: function (t, e, i) {
                ...
                for (var h = 0, c = i.emptyItemWidth, d = t.get("height"), f = a.getAvailableSize(i.pos, i.box),
                         p = i.totalWidth, g = i.renderList, v = g.length - 1; v >= 0; v--) {
        ...
        t.exports = o.extend({
            ...
            getDataParams: function (t) {
                for (var e = o.prototype.getDataParams.apply(this, arguments), i = this.getData(),
                         n = i.tree.getNodeByDataIndex(t), r = e.treePathInfo = []; n;) {
                    var a = n.dataIndex;
        ...
        for (var n = i(2), r = i(170), o = function () {
                 ...
                 s = 0; s < a.length; s++)n.registerAction({type: a[s], update: "updateView"}, o);
        ...
        function u(t, e, i) {
            for (var n, r = 0, o = 1 / 0, a = 0,
                     s = t.length; s > a; a++)n = t[a].getLayout().area, n && (o > n && (o = n), n > r && (r = n));
        ...
        i(2).extendComponentView({
            type: "angleAxis", render: function (t, e) {
                ...
                for (var r = t.axis, s = t.get("data"), l = t.getModel("axisLabel"), u = l.getModel("textStyle"),
                         h = t.getFormattedLabels(), c = l.get("margin"), d = r.getLabelsCoords(),
                         f = 0; f < i.length; f++) {
                ...
                for (var h = [], c = Math.PI / 180, d = -i[0] * c, f = Math.min(n[0], n[1]), p = Math.max(n[0], n[1]),
                         g = t.get("clockwise"), v = 1; v < i.length; v++) {
                    var m = u++ % l.length;
        ...
        var r = i(50), o = i(1), a = i(3), s = r.getInterval, l = r.ifIgnoreOnTick,
            u = ["axisLine", "axisLabel", "axisTick", "axisName"], h = "splitLine", c = i(2).extendComponentView({
                type: "singleAxis", render: function (t, e) {
                    ...
                    u = u instanceof Array ? u : [u];
                    for (var c = t.coordinateSystem.getRect(), d = i.isHorizontal(), f = [], p = 0, g = i.getTicksCoords(),
                             v = [], m = [], y = 0; y < g.length; ++y)if (!l(i, y, h)) {
        ...
        t.exports = i(2).extendComponentView({
            type: "radar", render: function (t, e, i) {
                ...
                if (a.length) {
                    ...
                    var v = [], m = [];
                    if ("circle" === s)for (var y = a[0].getTicksCoords(), x = i.cx, _ = i.cy,
                                                b = 0; b < y.length; b++) {
                        if (d) {
                            var w = e(v, p, b);
        ...
        function r(t) {
            ...
            for (var i = -(1 / 0), n = 0; n < t.length; n++)for (var r = t[n].interval, o = t[n].close,
                                                                     a = 0; 2 > a; a++)r[a] < i && (r[a] = i, o[a] = 1 - a), i = r[a]
        }
            ...
            splitNumber: function () {
                ...
                a.each(t.pieces, function (t, i) {
                    ...
                    if (null != t.label && (n.text = t.label), t.hasOwnProperty("value")) {
                        ...
                        for (var o = n.interval = [], l = n.close = [0, 0], u = [1, 0, 1], h = [-(1 / 0), 1 / 0],
                                 c = [], d = 0; 2 > d; d++) {
                            for (var f = [["gte", "gt", "min"], ["lte", "lt", "max"]][d],
                                     p = 0; 3 > p && null == o[d]; p++)o[d] = t[f[p]], l[d] = u[p], c[d] = 2 === p;
                            null == o[d] && (o[d] = h[d])
                        }
        ...
        for (var n = i(238), r = [126, 25],
                 o = [[[0, 3.5], [7, 11.2], [15, 11.9], [30, 7], [42, .7], [52, .7], [56, 7.7], [59, .7], [64, .7], [64, 0], [5, 0], [0, 3.5]], [[13, 16.1], [19, 14.7], [16, 21.7], [11, 23.1], [13, 16.1]], [[12, 32.2], [14, 38.5], [15, 38.5], [13, 32.2], [12, 32.2]], [[16, 47.6], [12, 53.2], [13, 53.2], [18, 47.6], [16, 47.6]], [[6, 64.4], [8, 70], [9, 70], [8, 64.4], [6, 64.4]], [[23, 82.6], [29, 79.8], [30, 79.8], [25, 82.6], [23, 82.6]], [[37, 70.7], [43, 62.3], [44, 62.3], [39, 70.7], [37, 70.7]], [[48, 51.1], [51, 45.5], [53, 45.5], [50, 51.1], [48, 51.1]], [[51, 35], [51, 28.7], [53, 28.7], [53, 35], [51, 35]], [[52, 22.4], [55, 17.5], [56, 17.5], [53, 22.4], [52, 22.4]], [[58, 12.6], [62, 7], [63, 7], [60, 12.6], [58, 12.6]], [[0, 3.5], [0, 93.1], [64, 93.1], [64, 0], [63, 0], [63, 92.4], [1, 92.4], [1, 3.5], [0, 3.5]]],
                 a = 0; a < o.length; a++)for (var s = 0; s < o[a].length; s++)o[a][s][0] /= 10.5, o[a][s][1] /= -14, o[a][s][0] += r[0], o[a][s][1] += r[1];
        t.exports = function (t) {
        ...
        function n(t) {
            ...
            for (var e = t.features, i = 0; i < e.length; i++)for (var n = e[i], o = n.geometry, a = o.coordinates,
                                                                       s = o.encodeOffsets, l = 0; l < a.length; l++) {
                var u = a[l];
        ...
        n.prototype = {
            type: "parallel", constructor: n, _init: function (t, e, i) {
                ...
                for (var n = this.dimensions, r = this._axesMap, o = this.hasAxisbrushed(), a = 0,
                         s = t.count(); s > a; a++) {
                ...
                for (var t = this.dimensions, e = this._axesMap, i = !1, n = 0,
                         r = t.length; r > n; n++)"normal" !== e[t[n]].model.getActiveState() && (i = !0);
                return i
        ...
        s.type = "graph", s.isDirected = function () {
            ...
            for (var i = this.edges, n = i.length,
            ...
            if (e instanceof n || (e = this._nodesMap[e]), e) {
                for (var o = "out" === i ? "outEdges" : "in" === i ? "inEdges" : "edges",
                         a = 0; a < this.nodes.length; a++)this.nodes[a].__visited = !1;
                if (!t.call(r, e, null))for (var s = [e]; s.length;)for (var l = s.shift(), u = l[o],
                                                                             a = 0; a < u.length; a++) {
            ...
            for (var t = this.data, e = this.edgeData, i = this.nodes, n = this.edges, r = 0,
            ...
            for (var t = new a(this._directed), e = this.nodes, i = this.edges,
                     n = 0; n < e.length; n++)t.addNode(e[n].id, e[n].dataIndex);
            for (var n = 0; n < i.length; n++) {
                var r = i[n];
