$(function(){
	//密码显示
	$(".glyphicon-eye-close").mousedown(function(){
		$(this).addClass("glyphicon-eye-open");
		$(this).removeClass("glyphicon-eye-close");
		$(this).prev(".form-control").attr("type","text");
	});
	//密码不显示
	$(".glyphicon-eye-close").mouseup(function(){
...
/* 正则验证*/
var oldPwdTest=new RegExp("[0-9]{6,15}");
var newPwdTest=new RegExp("[0-9]{6,15}");
var surePwdTest=new RegExp("[0-9]{6,15}");
...
//提交拦截
function sureUpdate(){
	if(oldPwdLab==1&&newPwdLab==1&&surePwdLab==1&&addressLab==1&&phoneLab==1){
		return true;
	}else{
